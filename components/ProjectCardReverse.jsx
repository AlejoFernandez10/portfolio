...
const ProjectCardReverse = ({title, img,  description, urlDeploy, urlRepo}) => {
  ...
  return (
    ...
    <div className={'flex w-full justify-between mt-5 md:w-[80%]'}>
      ...
      <div className={' pb-10 self-start ml-1 flex gap-4 '}>
        <a href={urlRepo} target='_blank' className={'flex flex-col text-xs text-[#9333EA]'}><AiOutlineGithub  className={'text-[24px]'}/></a>
